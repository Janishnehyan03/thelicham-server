        ...
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
          <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            ...
            <div className="flex justify-center">
              <a
                href="https://www.facebook.com/thelitchammagazine"
              ...
              <a
                href="https://twitter.com/thelitcham"
                className="mr-6 text-gray-600"
              >
                <svg
                  aria-hidden="true"
              ...
              <a
                href="https://www.instagram.com/thelicham_monthly/"
                className="mr-6 text-gray-600"
              >
                <svg
                  aria-hidden="true"
            ...
            <div className="lg:flex lg:justify-between lg:items-center">
              <div className="lg:max-w-[50%]">
                ...
                <p className="text-left">
                  Thelicham Monthly is a leading Islamic monthly in Malayalam
                  language published from Darul Huda Islamic University, Kerala.
                </p>
              </div>
